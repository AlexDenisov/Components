...
GH_REPO=AliSoftware/OHHTTPStubs
...
COMPONENT_XCODEPROJ_PATH=$(COMPONENT_SOURCE_PATH)/$(NAME)-$(VERSION)/$(NAME)/$(NAME).xcodeproj
COMPONENT_ARTEFACT_PATH=$(COMPONENT_SOURCE_PATH)/Artefacts/$(NAME)
...
$(COMPONENT_INSTALL_PATH): | $(COMPONENT_ARTEFACT_PATH)
	...
	cp -rv $(COMPONENT_ARTEFACT_PATH)/$(NAME).framework $(COMPONENT_INSTALL_PATH)
...
$(COMPONENT_ARTEFACT_PATH): | $(COMPONENT_SOURCE_PATH)
	xcodebuild \
		...
		-scheme "OHHTTPStubs iOS Framework" \
		-configuration Debug \
		-sdk iphonesimulator \
