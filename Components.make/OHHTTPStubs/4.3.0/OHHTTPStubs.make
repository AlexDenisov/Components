...
COMPONENT_ZIPBALL_URL=https://github.com/${GH_REPO}/releases/download/${VERSION}/OHHTTPStubs.framework.zip
...
COMPONENT_FRAMEWORK_PATH=$(COMPONENT_SOURCE_PATH)/Carthage/Build/iOS/$(NAME).framework
