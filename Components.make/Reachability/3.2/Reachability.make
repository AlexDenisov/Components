NAME=Reachability
VERSION=3.2
GH_REPO=tonymillion/Reachability
...
# https://github.com/tonymillion/Reachability/archive/v3.2.zip
...
$(COMPONENT_INSTALL_PATH): $(COMPONENT_ARTEFACTS_PATH)
	mkdir $(COMPONENT_INSTALL_PATH)
	cp -R $(COMPONENT_ARTEFACTS_PATH)/*\.[h,m] $(COMPONENT_INSTALL_PATH)

$(COMPONENT_ARTEFACTS_PATH): $(COMPONENT_ZIPBALL_PATH)
	...
	touch $(COMPONENT_ARTEFACTS_PATH)
