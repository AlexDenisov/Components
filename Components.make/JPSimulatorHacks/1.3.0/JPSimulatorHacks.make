...
VERSION=1.3.0
GH_REPO=https://github.com/plu/JPSimulatorHacks

### URLs

COMPONENT_ZIPBALL_URL=$(GH_REPO)/archive/$(VERSION).zip
...
$(COMPONENT_INSTALL_PATH): $(COMPONENT_SOURCE_PATH)
	...
	cp -Rv $(COMPONENT_ARTEFACT_PATH)/JPSimulatorHacks/JPSimulatorHacks.[hm] $(COMPONENT_INSTALL_PATH)
	cp -Rv $(COMPONENT_ARTEFACT_PATH)/JPSimulatorHacks/JPSimulatorHacksDB.[hm] $(COMPONENT_INSTALL_PATH)
