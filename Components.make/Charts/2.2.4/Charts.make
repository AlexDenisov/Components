...
GH_REPO=https://github.com/danielgindi/Charts
ZIPBALL_URL=$(GH_REPO)/releases/download/v$(VERSION)/Charts.framework.zip
...
COMPONENT_FRAMEWORK_PATH=$(COMPONENT_SOURCE_PATH)/Carthage/Build/iOS/Charts.framework
